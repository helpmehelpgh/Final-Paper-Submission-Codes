...
METADATA_PATH = "stead_full/results/metadata/binary_full_balanced.csv"
MODEL_PATH = "stead_full/results/models/best_binary_full_cnn.pt"
...
def main():
    ...
    plt.imshow(cm)
    plt.title("Confusion Matrix: Full Binary Classification")
    ...
    plt.colorbar()
    plt.tight_layout()
    plt.savefig(f"{FIGURES_DIR}/binary_full_confusion_matrix.png", dpi=300)
    plt.close()

    print("\nSaved figure:")
    print(f"{FIGURES_DIR}/binary_full_confusion_matrix.png")
