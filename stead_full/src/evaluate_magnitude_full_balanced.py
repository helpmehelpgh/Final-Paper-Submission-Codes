...
MODEL_PATH = "stead_full/results/models/best_magnitude_full_balanced_cnn.pt"
...
def main():
    ...
    plt.imshow(cm)
    plt.title("Confusion Matrix: Full Balanced Magnitude Classes")
    ...
    plt.tight_layout()
    plt.savefig(
        f"{FIGURES_DIR}/magnitude_full_balanced_confusion_matrix.png",
        dpi=300
    )
    plt.close()

    print("\nSaved figure:")
    print(f"{FIGURES_DIR}/magnitude_full_balanced_confusion_matrix.png")
