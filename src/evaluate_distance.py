...
def main():
    ...
    plt.imshow(cm)
    plt.title("Confusion Matrix: Distance Classes")
    ...
    plt.colorbar()
    plt.tight_layout()
    plt.savefig("results/figures/distance_confusion_matrix.png", dpi=300)
    plt.close()

    print("\nSaved figure:")
    print("results/figures/distance_confusion_matrix.png")
