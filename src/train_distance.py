...
def main():
    ...
    df = df.dropna(subset=["source_distance_km"]).copy()
    ...
    dataset = STEADDistanceDataset(df, HDF5_PATH)
    ...
    for epoch in range(1, EPOCHS + 1):
        ...
        if val_acc > best_val_acc:
            ...
            torch.save(model.state_dict(), "results/models/best_distance_cnn.pt")

    print("Best validation accuracy:", best_val_acc)
    print("Saved model: results/models/best_distance_cnn.pt")
