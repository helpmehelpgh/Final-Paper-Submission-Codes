...
MODEL_PATH = "results/models/best_magnitude_cnn.pt"
...
def main():
    ...
    dataset = STEADMagnitudeDataset(df, HDF5_PATH)
    ...
    plt.imshow(cm)
    plt.title("Confusion Matrix: Magnitude Classes")
    ...
    plt.colorbar()
    plt.tight_layout()
    plt.savefig("results/figures/magnitude_confusion_matrix.png", dpi=300)
    plt.close()

    print("\nSaved figure:")
    print("results/figures/magnitude_confusion_matrix.png")
